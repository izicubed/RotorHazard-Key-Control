...
* Each panel row shows the pilot, the judge **code** and two small controls.
  The code opens that judge page in a new tab, **QR** fills the panel with a
  code for the judge to scan off your screen, and clicking anywhere else in
  the row copies the full link.
